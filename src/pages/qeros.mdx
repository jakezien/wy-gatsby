...
<CoverPhoto bigText scrim bg={<BgVideo src={OfferingMp4}/>} className="qeros-animation-0">
...
Love, joy, perseverance, intrinsic integrity, and contentment suffuse their daily lives.
